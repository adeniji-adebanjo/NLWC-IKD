...
export default function GivePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <div className="pt-24 pb-20 bg-gradient-to-b from-primary/5 via-background to-background">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative p-6 rounded-2xl border-2 border-primary/20 bg-primary/5 flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="text-center sm:text-left">
                        ...
                        <p className="text-3xl sm:text-4xl font-black tracking-wider text-primary tabular-nums">
                      ...
                      <Button
                        ...
                        size="default"
                        className={cn(
                          "rounded-xl px-4 h-11 font-bold transition-all shrink-0 w-full sm:w-auto",
                          copied
